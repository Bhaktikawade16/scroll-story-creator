    ...
    <main className="relative bg-background text-foreground">
      ...
      <section className="relative flex h-screen items-center justify-center overflow-hidden">
        ...
        <motion.div
          ...
          className="font-display text-center text-xs text-foreground/80 sm:text-sm"
        >
          SETUPVERSE
        </motion.div>
        <motion.div
          ...
          className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[10px] tracking-[0.3em] text-muted-foreground"
        >
          SCROLL
        </motion.div>
      </section>
        ...
        >
          {(p) => (
            <div className="pointer-events-none absolute inset-0 flex flex-col justify-center px-6 sm:px-12 lg:px-20">
              ...
              >
                <h1 className="text-cine text-[16vw] leading-[0.85] sm:text-[12vw] lg:text-[9vw]">
                  BUILD
                  <br />
                  YOUR SPACE.
                </h1>
      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 sm:px-12">
          <Reveal>
            <h2 className="text-cine text-[13vw] sm:text-[9vw] lg:text-[6.5vw]">
              YOUR SETUP
              <br />
              STARTS WITH
              <br />
              <span className="text-accent">AN IDEA.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.15}>
        ...
        {(p) => (
          <div className="pointer-events-none absolute inset-0 flex flex-col items-end justify-center px-6 text-right sm:px-12 lg:px-20">
            {["SEE IT.", "EXPLORE IT.", "MAKE IT YOURS."].map((line, i) => (
              <span
                key={line}
                className="text-cine block text-[12vw] sm:text-[8vw] lg:text-[6vw]"
                style={{
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden py-32">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 sm:px-12">
          <Reveal>
            <h2 className="text-cine text-[14vw] sm:text-[9vw] lg:text-[7vw]">
              IT&apos;S NOT JUST
              <br />A PC.
            </h2>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <ul className="mt-14 flex flex-wrap gap-x-8 gap-y-4">
              {PARTS.map((p) => (
                <li
                  key={p}
                  className="text-[10px] tracking-[0.3em] text-muted-foreground transition-colors hover:text-accent sm:text-xs"
                >
                  {p}
                </li>
              ))}
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 py-32 text-center">
        ...
        <Reveal>
          <h2 className="text-cine relative text-[13vw] sm:text-[9vw] lg:text-[6.5vw]">
            WHAT IF
            <br />
            YOU COULD
            <br />
        ...
        <Reveal delay={0.15}>
          <motion.img
            ...
            loading="lazy"
            className="mx-auto mt-16 w-[min(680px,90vw)] rounded-2xl opacity-90 mix-blend-screen"
            initial={{ scale: 1 }}
      ...
      >
        ...
        <div className="relative w-full max-w-5xl">
          ...
          <Reveal delay={0.1}>
            <div className="relative mt-12 overflow-hidden rounded-3xl glass-panel">
              <img
                src={cpuAsset.url}
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 py-32 text-center">
        ...
        <div className="relative">
          <Reveal>
            <h2 className="text-cine text-[15vw] sm:text-[10vw] lg:text-[7.5vw]">
              MAKE
              <br />
              YOUR OWN
              <br />
      ...
      <footer className="border-t border-border/40 px-6 py-10 text-center text-[10px] tracking-[0.3em] text-muted-foreground">
        SETUPVERSE
      </footer>
    </main>
  );
